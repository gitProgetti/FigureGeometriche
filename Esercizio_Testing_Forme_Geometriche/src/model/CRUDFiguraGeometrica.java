...
public class CRUDFiguraGeometrica implements ICRUDFiguraGeometrica {
	...
	public boolean carica() {
		...
		try(BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\mauri\\Desktop\\Corso Java\\Lezione 11\\dati\\figuregeometriche.dat"))) {
	...
	public boolean salva() {
		// Creare la cartella c:\dati
		try(FileWriter fileWriter = new FileWriter("C:\\Users\\mauri\\Desktop\\Corso Java\\Lezione 11\\dati\\figuregeometriche.dat")) {
